...
const latest = () => {
  return (
    <div className=" h-max grid grid-col-1 md:grid-cols-2 mt-20 p-8  ">
      <div>
        <Image alt={'latest image'} src={latest_img} width={450} height={500} />
      </div>
      <div className="felx flex-col justify-between">
        ...
        <h1 className="text-4l text-gray-400">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam et est
          leo. Nulla fermentum ultrices ullamcorper. Nam eleifend mi sed sem
